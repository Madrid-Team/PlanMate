...
//    }
    ...
    @Test
    fun `should display tasks grouped by state correctly`() = runTest {
        runTest {
            // Given
            val projectId = UUID.randomUUID().toString()
            val tasks = listOf(
                helperTask(id = UUID.randomUUID().toString(), title = "Task 1", description = "Description 1", state = "TODO", projectId = projectId ),
                helperTask(id = UUID.randomUUID().toString(), title = "Task 2", description = "Description 2", state = "IN_PROGRESS", projectId = projectId ),
                helperTask(id = UUID.randomUUID().toString(), title = "Task 3", description = "Description 3", state = "IN_PROGRESS", projectId = projectId ),
            )
            ...
            verify { taskViewer.printTasksByState(tasks) }
        }
    }
